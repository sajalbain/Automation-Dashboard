              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div>
                    ...
                    ?>
                      <a href="/registration.php" class='btn btn-info' style="float:right;margin:5px;">Add New User</a>
                    <?php } ?>
                  </div>
                </div>
                <!-- /.card-header -->
                          ...
                          <td>
                            <div>
                              ...
                              ?><form method='get' action='/user_update.php'>
                                  <input type="hidden" value="<?php echo $row[2]; ?>" name="corpid">
                                  <input type="submit" class="btn btn-block btn-success btn-sm" value="Update">
                                </form>
                              <?php
                              } else {
                              ?><form method='get' action='/user_update.php'>
                                  <input type="hidden" value="<?php echo $row[2]; ?>" name="corpid">
                                  <input type="submit" class="btn btn-block btn-danger btn-sm" value="Update">
                                </form>
                              <?php
                              }
                              ?>
