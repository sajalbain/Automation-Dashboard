...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $manualruntime = mysqli_real_escape_string($db, $_POST['manualruntime']);
  $sql1 = "insert into appruntime values('$appname','','','','$manualruntime','0',0,'')";
  $sql = "insert into apps (appname,path) values ('$appname','$path')";
  mysqli_query($db, $sql);
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="/appslist.php" class="nav-link active">
            ...
            <div class="col-lg-6 ">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Automation Registration</h3>
                </div>
                <form action="" method="post">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="CORPID">Automation Name</label>
                    ...
                    <div class="form-group">
                      <label for="First Name">Expected Runtime</label>
                      <input type="text" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]" name="manualruntime" placeholder="H:M:S" class="form-control" required>
                    </div>
                    <div class="form-group">
