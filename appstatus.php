...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="logout.php" role="button"><i
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="dist/img/OpelLogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        ...
        <div class="row"> 
          <div class="col-lg-6">
            <div class="alert alert-info">
                  <h1><i class="icon fas fa-ban"></i> Alert!</h1>
                  <h3>We are still building UI</h3>
            </div>
          </div>
          <!-- /.col-md-6 -->
        </div>
