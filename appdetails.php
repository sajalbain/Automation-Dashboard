...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "SELECT * FROM apps where appname = '$appname'";
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Automation Details</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <form action="" method="post">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="appname" value="<?php echo $row[0];
                                                                ?>" class="form-control" disabled>
                    </div>
                    <div class="form-group">
                      <label for="First Name">Path</label>
                      <input type="text" name="path" value="<?php echo $row[1];
                                                            ?>" class="form-control" disabled>
                    </div>
                    <div class="form-group">
